 ...
 */
export async function getStripeAccountId(tenantId) {
...
export async function ensureConnectedAccount(tenantId) {
    ...
    if (tenant.stripe?.accountId)
        return tenant.stripe.accountId;
...
export function computeApplicationFeeAmount(amount, bps) {
