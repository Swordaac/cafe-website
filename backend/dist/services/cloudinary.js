...
class CloudinaryService {
    ...
    async uploadImage(file, tenantId, productId) {
        try {
    ...
    async uploadCategoryImage(file, tenantId, categoryId) {
        try {
            const sanitizedTenantId = this.sanitizeTenantId(tenantId);
    ...
    async updateImage(file, tenantId, productId) {
    ...
    async updateCategoryImage(file, tenantId, categoryId) {
    ...
    async getImagesByTenant(tenantId) {
        try {
            const sanitizedTenantId = this.sanitizeTenantId(tenantId);
